      ...
      <div className="relative z-10 w-full max-w-md p-4">
        <div className="glass rounded-2xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-primary-light/50 mt-2 text-sm">Sign in to your AI Learning Platform</p>
          </div>
          ...
          <a href="#" className="block text-center text-sm text-indigo-400/60 hover:text-primary-light transition-colors mt-2">
            Forgot password?
          </a>
        </div>
      </div>
